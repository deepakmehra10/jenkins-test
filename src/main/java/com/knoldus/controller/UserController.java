...
public class UserController {
    ...
    @GetMapping("/welcome")
    public Mono<ResponseEntity<String>> welcome(@RequestParam(required = false, defaultValue = "false") String noBillingAccount) {
        return Mono.just(ResponseEntity.ok().body("Welcome"));
    }
